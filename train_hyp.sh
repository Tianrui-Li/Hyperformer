...
python main.py  \
--config config/nturgbd-cross-subject/joint.yaml --model model.Hyperformer.Model --work-dir work_dir/ntu60/csub/Hyperformer_joint  --device 0 --base-lr 2.5e-2
...
#python main.py \
#--config config/nturgbd-cross-subject/joint.yaml  --model model.Hyperformerplus.DecoupledAttention --work-dir work_dir/ntu60/csub/Decoupled_joint --device 4 5

#python main.py  \
#--config config/nturgbd-cross-subject/joint.yaml --model model.coupledformer.CoupledFormer --work-dir work_dir/ntu60/csub/CoupledFormer_joint  --device 0 1 2 3 --base-lr 2.5e-2 --batch-size 64