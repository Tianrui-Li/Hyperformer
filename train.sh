...
python main.py  \
--config config/nturgbd-cross-subject/joint.yaml --model model.Hyperformer.Model --work-dir work_dir/ntu60/csub/Hyperformer_joint  --device 0 3 --base-lr 2.5e-2 --batch-size 128
